...
window = tk.Tk()
window.title("Human Detection & Counting")
...
if exit1==False:
    ...
    window1 = tk.Tk()
    window1.title("Human Detection & Counting")
    ...
    def image_option():
        ...
        def detectByPathImage(path):
            ...
            Button(windowi, text="count report", command=img_gen_report, cursor="hand2", font=("Arial", 20),bg="light gray", fg="blue").place(x=325, y=550)
#-----------------------------------------------------------------------------------
            ''' tb=Text(height=10,width=40)
            tb.insert(max_count1)'''
 #------------------------------------------------------------------------------           
        def prev_img():
            global filename1
    ...
    def video_option():
        ...
        def detectByPathVideo(path, writer):
            ...
            Button(windowv, text="count report", command=vid_gen_report, cursor="hand2", font=("Arial", 20),bg="gray", fg="blue").place(x=325, y=550)
    ...
    def camera_option():
        ...
        def detectByCamera(writer):
            ...
            Button(windowc, text="count report", command=cam_gen_report, cursor="hand2", font=("Arial", 20),bg="gray", fg="blue").place(x=325, y=550)
